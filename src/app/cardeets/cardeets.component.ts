...
@Component({
  selector: 'app-cardeets',
  templateUrl: './cardeets.component.html',
  styleUrls: ['./cardeets.component.css']
})
export class CardeetsComponent implements OnInit {
  ...
  get Deets (): (string | number)[]{
    this.Vehicles2.push(this.vehicle[this.num].image,this.vehicle[this.num].name, this.vehicle[this.num].model,
      ...
      this.vehicle[this.num].color,this.vehicle[this.num].year, this.vehicle[this.num].dateadded)
